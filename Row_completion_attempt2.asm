...
check_if_any_row_is_completed:
    ...
    li $t0, 0           # Holds the x coordinate
    li $t1, 51          # Holds the y coordinate
    lw $t3, displayaddress
    Loop_for_y_start:
        li $t0, 0
        li $t2, 1       # This holds the boolean that tells us if all the values are white
        Loop_for_x_start:
            # Getting the value at the 
            beq $t0, 125, Loop_for_x_start
            addi $t0, $t0, 10
            j Loop_for_x_start
        Loop_for_x_end:
