...
addi $a1, $zero, 0      # set x coordinate of line to 2
addi $a2, $zero, 1      # set length of line to 8
addi $a3, $zero, 32      # set length of line to 8
jal draw_rectangle        # call the rectangle-drawing function

addi $a0, $zero, 0      # set x coordinate of line to 2
addi $a1, $zero, 31      # set x coordinate of line to 2
addi $a2, $zero, 32      # set length of line to 8
addi $a3, $zero, 1      # set length of line to 8
jal draw_rectangle        # call the rectangle-drawing function

addi $a0, $zero, 31      # set x coordinate of line to 2
addi $a1, $zero, 0      # set x coordinate of line to 2
addi $a2, $zero, 1      # set length of line to 8
addi $a3, $zero, 32      # set length of line to 8
jal draw_rectangle        # call the rectangle-drawing function
...
# - t6: the bitmap location fot the end of the vertical line. GUESSSSSS !!
draw_rectangle:
li $t5, 0
li $t6, 0
