...
wall_colour: .word 0xAA4A44     # brick red
...
li $a0, 0 #i= 0
li $a1, 262100 # total number of addresses (256*256*4 = 262144)

make_black_background:
beq $a0, $a1, make_walls #if a0 has reached all address, end function
