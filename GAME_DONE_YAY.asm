...
lw $a0, next_trimino
    ...
    beq $a0, 5, Making_I_Trimino_next
    beq $a0, 6, Making_O_Trimino_next
...
respond_to_P:
    pause_start:
        ...
        # sw $a0, x_offset
        # sw $a1, y_offset
        beq $t8, 1, could_be_cont      # If first word 1, key is pressed
        j pause_start
could_be_cont:
    lw $t0, ADDR_KBRD               # $t0 = base address for keyboard
    li $t1, 0
...
mapping_rotation:
    ...
    Checking_I:
    # Check for (20, 20)
    bne $a0, 20, Checking_I1
    bne $a1, 20, Checking_I1
    ...
    Checking_I1:
    # Check for (10, 30)
    bne $a0, 10, Checking_I2
    bne $a1, 30, Checking_I2
    ...
    Checking_I2:
    # Check for (30, 10)
    bne $a0, 30, Checking_finshed
    # bne $a1, 10, Checking_finshed
...
initialize_new_trimino:
    ...
    beq $a0, 5, Making_I_Trimino
    beq $a0, 6, Making_O_Trimino
    Making_T_Trimino:
        # Hard codding to initialize a T everytime
        li $v0, 42
        li $a0, 0
